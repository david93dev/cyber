...
const Subnav = () => {
  return (
    <div className="w-full h-12 bg-[#2E2E2E] flex justify-center items-center gap-8">
      <div className="text-[#E4E4E4] font-bold flex justify-center items-center gap-8">
        <a
          href="#"
          className="text-sm hover:opacity-70 flex items-center gap-2 border-r pr-8"
        >
          <span>
            <svg
              width="24"
